declare module '@async-fn/jest' {
  ...
  type AsyncFnMock<TToBeMocked extends (...args: any[]) => any> = jest.MockedFunction<TToBeMocked> & {
    resolve: (...resolvedValue: TentativeTuple<ReturnType<TToBeMocked> | Awaited<ReturnType<TToBeMocked>>>) => Promise<void>;

    resolveSpecific: (
      callFinder:
        | PartialDeep<Parameters<TToBeMocked>>
        | ((parameters: Parameters<TToBeMocked>) => boolean),
      ...resolvedValue: TentativeTuple<ReturnType<TToBeMocked> | Awaited<ReturnType<TToBeMocked>>>
    ) => Promise<void>;
